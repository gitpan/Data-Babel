...
# all combinations of regular types work
my $power_set=Set::Scalar->new(@regular_idtypes)->power_set;
my @output_subsets=map {[$_->members]} grep {$_->size>=2} $power_set->members;
push(@output_subsets,[@regular_idtypes,@regular_idtypes]); # to test duplicate ouputs
# add in specific combinations with multi types that produce pseudo-dups
push(@output_subsets,
     [qw(type_001 type_multi_001 type_004)],
     [qw(type_002 type_multi_001 type_004)],
     [qw(type_003 type_multi_001 type_004)],
     [qw(type_001 type_multi_003 type_004)],
     [qw(type_002 type_multi_003 type_004)],
     [qw(type_002 type_multi_001 type_multi_003)],
     [qw(type_004 type_multi_001 type_multi_003)],
     [qw(type_001 type_004 type_multi_001 type_multi_003)],
     [qw(type_002 type_004 type_multi_001 type_multi_003)],
     );
